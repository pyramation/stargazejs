...
export interface Ics721ReadOnlyInterface {
    ...
    tokens: ({ channelId, classId }: {
        channelId: string;
        classId: string;
    }) => Promise<TokensResponse>;
}
export declare class Ics721QueryClient implements Ics721ReadOnlyInterface {
...
export declare class Ics721Client extends Ics721QueryClient implements Ics721Interface {
